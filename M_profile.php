                  ...
                  <div class="tab-pane fade show active height-100-p" id="setting" role="tabpanel">
                    <div class="profile-setting">
                      <ul class="profile-edit-list row">
                              ...
                              <form class="" action="M_profile_update.php" method="post">
                              ...
                              <div class="form-group">
															...
															<div class="form-group">
																<label>Gender</label>
																<select value="<?= $users['gender']?>" class="selectpicker form-control form-control-lg" name="gender" data-style="btn-outline-secondary btn-lg" title="<?= $users['gender']?>" required>
